      ...
      <v-app id="inspire" class="app">
        ...
        <v-content>
          ...
          <div class="page-wrapper">
             <div :class="loading_app ? 'overlay-loading' : 'overlay-loading-off' " style="background-color: #F8FCFF">
                <div>
          ...
          <v-footer height="auto" class="white pa-3 app--footer">
            ...
            <v-spacer></v-spacer>
            <span class="caption mr-1"> <b>Made By Tim ERP, IT & HRIS</b> </span>
          </v-footer>
        </v-content>
        <!-- Go to top -->
        <app-fab></app-fab>
